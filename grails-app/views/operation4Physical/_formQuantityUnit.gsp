...
<div class="fieldcontain ${hasErrors(bean: quantityUnitInstance, field: 'physicalQuantity', 'error')} required">
	...
	<g:select id="physicalQuantity" name="physicalQuantity.id" from="${cn.edu.cup.physical.PhysicalQuantity.list()}" optionKey="id" required="" value="${quantityUnitInstance?.physicalQuantity?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: quantityUnitInstance, field: 'unitSystem', 'error')} required">
	...
	<g:select id="unitSystem" name="unitSystem.id" from="${cn.edu.cup.physical.UnitSystem.list()}" optionKey="id" required="" value="${quantityUnitInstance?.unitSystem?.id}" class="many-to-one"/>
